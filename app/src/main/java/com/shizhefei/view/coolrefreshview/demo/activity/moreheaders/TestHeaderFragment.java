...
import com.shizhefei.view.coolrefreshview.header.TestHeader;
...
public class TestHeaderFragment extends LazyFragment implements RefreshEvent {
    ...
    protected void onCreateViewLazy(Bundle savedInstanceState) {
        ...
        Log.d("wsx","TestHeaderFragment :onCreateViewLazy");
        ...
        coolRefreshView.setPullHeader(new TestHeader());
